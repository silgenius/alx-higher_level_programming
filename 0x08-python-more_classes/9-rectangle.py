...
class Rectangle:
    ...
    def bigger_or_equal(rect_1, rect_2):
        ...
        one with a greater or equal area.
        ...
        Returns:
            Rectangle: The Rectangle instance with a greater or equal area.
        """
    ...
    def square(cls, size=0):
        """
        Creates a new Rectangle instance representing a
        square with equal width and height.

        Args:
            cls (type): The class (Rectangle) for creating the square.
